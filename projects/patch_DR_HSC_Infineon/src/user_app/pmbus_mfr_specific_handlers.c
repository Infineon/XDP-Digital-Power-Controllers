...
void PMBUS_HANDLE_MFR_CONFIG_THRESHOLD(PMBUS_PAGE_t page, PMBUS_DIRECTION_e direction)
{
	// update only if a read:
	if(direction==PMBUS_WRITE)
	{
...
void PMBUS_HANDLE_MFR_CONFIG_DELAY(PMBUS_PAGE_t page, PMBUS_DIRECTION_e direction)
{
	// update only if a read:
	if(direction==PMBUS_WRITE)
	{
...
void PMBUS_HANDLE_MFR_MAX_DUTY(PMBUS_PAGE_t page, PMBUS_DIRECTION_e direction)
{
	// update only if a read:
	if(direction==PMBUS_WRITE)
	{
