...
//void regulation_event_dummy(void);
...
//void Telemetry_IRQ_VOUT_HANDLE(Telemetry_IRQ_TYPE_t telem_type);
...
//void tracking_input_voltage(PMBUS_PAGE_t loop);
