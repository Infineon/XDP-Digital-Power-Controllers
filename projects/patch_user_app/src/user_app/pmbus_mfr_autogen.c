 ...
 */
PMBUS_CMD_t PMBUS_CMD_MFR_DISABLE_I2C;
uint8_t	PMBUS_CMD_MFR_DISABLE_I2C_DATA_LOOP0[1];  	// data array for command loop0
uint8_t	PMBUS_CMD_MFR_DISABLE_I2C_DATA_LOOP1[1];    // data array for command loop1 (pointer if common)

/* instantiate the command MFR_CNFG_DEBOUNCE.
 */
PMBUS_CMD_t PMBUS_CMD_MFR_CNFG_DEBOUNCE;
uint8_t	PMBUS_CMD_MFR_CNFG_DEBOUNCE_DATA_LOOP0[1];  	// data array for command loop0
uint8_t	PMBUS_CMD_MFR_CNFG_DEBOUNCE_DATA_LOOP1[1];    // data array for command loop1 (pointer if common)
...
void pmbus_mfr_autogen_init(void)
{
	...
	/* initialize command structure for MFR_DISABLE_I2C. */
	// MFR_DISABLE_I2C COMMAND:
	ptr_pmbus_callback[PMBUS_CMDCODE_MFR_DISABLE_I2C] = PMBUS_HANDLE_MFR_DISABLE_I2C;
	//PMBUS_CMD_MFR_DISABLE_I2C.OPCODE = PMBUS_CMDCODE_MFR_DISABLE_I2C;
	//PMBUS_CMD_MFR_DISABLE_I2C.WRITE_PROTOCOL = (uint8_t) TRANSACTION_PROTOCOL_WRITE;
	//PMBUS_CMD_MFR_DISABLE_I2C.READ_PROTOCOL = (uint8_t) TRANSACTION_PROTOCOL_READ;
	//PMBUS_CMD_MFR_DISABLE_I2C.NUM_BYTES = 1; // data only not including slave address and command
	//PMBUS_CMD_MFR_DISABLE_I2C.NUM_PROTOCOL_BYTES = 2;  // slave address command and any other non-data bytes
	//PMBUS_CMD_MFR_DISABLE_I2C.SUPPORTED = 1;
	//PMBUS_CMD_MFR_DISABLE_I2C.PROTECTED0 = 0;
	//PMBUS_CMD_MFR_DISABLE_I2C.PROTECTED1 = 0;
	//PMBUS_CMD_MFR_DISABLE_I2C.RANGE_TYPE = (uint8_t) PMBUS_RANGE_ALL;
	PMBUS_CMD_MFR_DISABLE_I2C.CMD_CONFIG = 0xc18123b3;
	PMBUS_CMD_MFR_DISABLE_I2C.DATA0 = &PMBUS_CMD_MFR_DISABLE_I2C_DATA_LOOP0[0];  // set the pointer to the data array
	PMBUS_CMD_MFR_DISABLE_I2C.DATA1 = &PMBUS_CMD_MFR_DISABLE_I2C_DATA_LOOP1[0];  // set the pointer to the data array
	// RANGE SUPPORT for MFR_DISABLE_I2C COMMAND:
	// now populate pointers to the supported commands for each page
	PMBUS_CMD_ARRAY_LOOP[PMBUS_CMDCODE_MFR_DISABLE_I2C] = &PMBUS_CMD_MFR_DISABLE_I2C;
	//PMBUS_CMD_ARRAY_LOOP1[PMBUS_CMDCODE_MFR_DISABLE_I2C] = &PMBUS_CMD_MFR_DISABLE_I2C;
	//lint -e{778} suppress "Constant expression evaluates to 0 in operation '&'" 
	PMBUS_CMD_SUPPORT_ARRAY_LOOP[PMBUS_CMDCODE_MFR_DISABLE_I2C/32] |= (uint32_t) ((uint32_t)1u << ((uint32_t)PMBUS_CMDCODE_MFR_DISABLE_I2C&31u));
	//PMBUS_CMD_SUPPORT_ARRAY_LOOP1[PMBUS_CMDCODE_MFR_DISABLE_I2C/32] |= (uint32_t) ((uint32_t)1u << ((uint32_t)PMBUS_CMDCODE_MFR_DISABLE_I2C&31u));

	/* initialize command structure for MFR_CNFG_DEBOUNCE. */
	// MFR_CNFG_DEBOUNCE COMMAND:
	ptr_pmbus_callback[PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE] = PMBUS_HANDLE_MFR_CNFG_DEBOUNCE;
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.OPCODE = PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE;
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.WRITE_PROTOCOL = (uint8_t) TRANSACTION_PROTOCOL_WRITE;
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.READ_PROTOCOL = (uint8_t) TRANSACTION_PROTOCOL_READ;
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.NUM_BYTES = 1; // data only not including slave address and command
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.NUM_PROTOCOL_BYTES = 2;  // slave address command and any other non-data bytes
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.SUPPORTED = 1;
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.PROTECTED0 = 0;
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.PROTECTED1 = 0;
	//PMBUS_CMD_MFR_CNFG_DEBOUNCE.RANGE_TYPE = (uint8_t) PMBUS_RANGE_ALL;
	PMBUS_CMD_MFR_CNFG_DEBOUNCE.CMD_CONFIG = 0xc18123b4;
	PMBUS_CMD_MFR_CNFG_DEBOUNCE.DATA0 = &PMBUS_CMD_MFR_CNFG_DEBOUNCE_DATA_LOOP0[0];  // set the pointer to the data array
	PMBUS_CMD_MFR_CNFG_DEBOUNCE.DATA1 = &PMBUS_CMD_MFR_CNFG_DEBOUNCE_DATA_LOOP1[0];  // set the pointer to the data array
	// RANGE SUPPORT for MFR_CNFG_DEBOUNCE COMMAND:
	// now populate pointers to the supported commands for each page
	PMBUS_CMD_ARRAY_LOOP[PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE] = &PMBUS_CMD_MFR_CNFG_DEBOUNCE;
	//PMBUS_CMD_ARRAY_LOOP1[PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE] = &PMBUS_CMD_MFR_CNFG_DEBOUNCE;
	//lint -e{778} suppress "Constant expression evaluates to 0 in operation '&'" 
	PMBUS_CMD_SUPPORT_ARRAY_LOOP[PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE/32] |= (uint32_t) ((uint32_t)1u << ((uint32_t)PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE&31u));
	//PMBUS_CMD_SUPPORT_ARRAY_LOOP1[PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE/32] |= (uint32_t) ((uint32_t)1u << ((uint32_t)PMBUS_CMDCODE_MFR_CNFG_DEBOUNCE&31u));
