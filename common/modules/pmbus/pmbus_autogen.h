...
#define PMBUS_CMDCODE_MFR_FIRMWARE_COMMAND_DATA (0xFD)

/* instantiate the command structure for MFR_FIRMWARE_COMMAND_DATA.
 */
// instances of the struct one per command
extern PMBUS_CMD_t PMBUS_CMD_MFR_FIRMWARE_COMMAND_DATA;
extern uint8_t	PMBUS_CMD_MFR_FIRMWARE_COMMAND_DATA_DATA_LOOP0[4];  	// data array for command loop0
extern uint8_t	* PMBUS_CMD_MFR_FIRMWARE_COMMAND_DATA_DATA_LOOP1;    // data array for command loop1 (pointer if common)
